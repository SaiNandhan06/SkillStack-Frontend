      ...
      <div className="relative z-10 max-w-[1280px] mx-auto px-6 py-32 flex flex-col items-center text-center">
            ...
            <div className="p-6 bg-[#0D0D16]">
              ...
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-[#00D9FF]/10 border border-[#00D9FF]/20">
                  ...
                  <span className="font-mono-accent text-xs text-[#00D9FF]">
                    LIVE
                  </span>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-6">
                {[
                  ...
                  >
                    ...
                    <div
                      className={`font-mono-accent text-xs ${stat.positive ? "text-[#00D9FF]" : "text-red-400"}`}
                    >
                      {stat.change}
                    </div>
                  </div>
              ...
              <div className="rounded-xl border border-white/5 bg-white/2 p-4 h-36 flex items-end gap-1">
                {[
                  40, 65, 45, 80, 55, 90, 70, 85, 60, 95, 75, 88, 65, 92, 78,
                  96, 82, 88, 72, 94,
                ].map((h, i) => (
                  <div
                    key={i}
        ...
        >
          ...
          <div className="flex items-center gap-1">
            ...
            <span className="font-mono-accent text-xs text-white/40 ml-1">
              4.9/5 on G2
            </span>
          </div>
        </motion.div>
