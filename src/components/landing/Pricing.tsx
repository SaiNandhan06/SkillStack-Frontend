...
const plans = [
  {
    ...
    price: "149",
    period: "/mo",
    description: "For individual analysts and small teams getting started with institutional-grade tools.",
    features: [
      "Up to 3 users",
      "50 data sources",
      "Basic AI signals",
  ...
  },
  {
    ...
    price: "499",
    period: "/mo",
    description: "For established funds and trading desks demanding real-time performance and AI-driven alpha.",
    features: [
      "Up to 25 users",
  ...
  },
  {
    ...
    price: "Custom",
    period: "",
    description: "For institutional asset managers requiring white-glove service, custom integrations, and SLAs.",
    features: [
      "Unlimited users",
...
export default function Pricing() {
  ...
  return (
    <section id="pricing" className="relative py-32 bg-[#0A0A0F] overflow-hidden">
      {/* Background */}
              ...
              <div className="relative mb-6">
                ...
                <div className="flex items-baseline gap-1 mb-3">
                  {plan.price === "Custom" ? (
                    ...
                    <>
                      <span className="font-mono-accent text-white/50 text-xl">$</span>
