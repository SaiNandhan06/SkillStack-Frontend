                ...
                {!submitted ? (
                  ...
                  >
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                      {[
                        { key: "name", label: "Full Name", placeholder: "Alexandra Kim", type: "text" },
                        { key: "email", label: "Work Email", placeholder: "alex@fund.com", type: "email" },
                        { key: "company", label: "Company", placeholder: "Apex Capital Partners", type: "text" },
                        { key: "aum", label: "AUM (Optional)", placeholder: "$500M+", type: "text" },
                      ].map((field) => (
                        <div key={field.key}>
                      ...
                      <p className="text-center font-body text-xs text-white/30">
                        ...
                        <a href="#" className="text-[#00D9FF]/70 hover:text-[#00D9FF]">
                          Terms of Service
                        </a>{" "}
                        and{" "}
                        <a href="#" className="text-[#00D9FF]/70 hover:text-[#00D9FF]">
                  ...
                  >
                    ...
                    <p className="font-body text-sm text-white/50 max-w-xs mx-auto mb-8">
                      Check your inbox for your access link. Onboarding usually completes within 24 hours.
                    </p>
                    <button
                      onClick={handleClose}
