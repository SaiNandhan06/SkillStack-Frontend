...
const faqs = [
  {
    question: "How does NexaFlow's AI signal engine work?",
    answer:
  ...
  {
    question: "Does NexaFlow support crypto and alternative assets?",
    answer:
