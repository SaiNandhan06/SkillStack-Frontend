    ...
    <section className="relative py-32 overflow-hidden bg-[#0A0A0F]">
      ...
      <div ref={ref} className="relative z-10 max-w-[1280px] mx-auto px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            Join 2,400+ finance teams already using NexaFlow to generate superior risk-adjusted returns. 14-day free trial, no credit card required.
          </motion.p>
          ...
          >
            <button
              ...
              style={{
                ...
                color: "black",
                boxShadow: "0 0 30px rgba(0, 217, 255, 0.3), 0 0 60px rgba(168, 85, 247, 0.15)",
              }}
            >
              Start Free Trial
