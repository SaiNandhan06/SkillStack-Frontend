...
const testimonials = [
  {
    ...
    avatar: "AK",
    content:
      "NexaFlow transformed how we approach portfolio management. The AI signals have added 340bps of alpha to our flagship fund in under six months. It's not a tool — it's a competitive advantage.",
  ...
  },
  {
    ...
    avatar: "MC",
    content:
      "We evaluated 14 platforms before choosing NexaFlow. The backtesting infrastructure alone saved us 3 months of engineering time. The risk dashboard is the best I've seen in 18 years of trading.",
...
export default function Testimonials() {
  ...
  return (
    <section id="testimonials" className="relative py-32 bg-[#0A0A0F] overflow-hidden">
      {/* Background */}
      ...
      <div ref={ref} className="relative z-10 max-w-[1280px] mx-auto px-6">
        ...
        >
          ...
          <p className="font-body text-lg text-white/50 max-w-md mx-auto">
            The firms that define markets use NexaFlow to stay ahead.
          </p>
        </motion.div>
